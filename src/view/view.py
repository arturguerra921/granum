...
app.layout = html.Div([
    ...
    # Start with a loading spinner centered on the screen
    html.Div(
        id='page-content',
        children=html.Div(
...
# Define validation layout so Dash knows about components generated by callbacks
...
@app.callback(
    ...
    # prevent_initial_call=True has been removed
)
